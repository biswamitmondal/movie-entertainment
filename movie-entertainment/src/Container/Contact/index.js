...
const  ContactContainer = ()=>{
    const myData = [
        ...
        {name:'Linkedin', link:'https://www.linkedin.com', text:'Follow to my linkedin.'},
        {name:'Twitter', link:'https://twitter.com', text:'Follow to my twitter.'},
        {name:'StackOverFlow', link:'https://stackoverflow.com', text:'Check out to my stackoverflow account.'},
        {name:'Blog', link:'https://www.facebook.com', text:'Follow to my blog.'},
        ...
        {name:'Email', link:'biswamitmondal@gmail.com',  text:'write to me a mail'}
    ]
    return (
